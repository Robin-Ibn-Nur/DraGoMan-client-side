        ...
        <div className='flex justify-center my-10'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex items-center pt-4 space-x-1">
                    ...
                    <p className="px-3 text-sm dark:text-gray-400">or Log in with social accounts</p>
                    <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
                </div>
                <div className="flex justify-center space-x-4">
                    ...
                    <button onClick={gitSignIn} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <p className="px-6 text-sm text-center dark:text-gray-400">Don't have an account yet?
                    <Link to="/signup" className="hover:underline dark:text-violet-400">Sign up</Link>
                </p>
            </div>
        </div>
    );
