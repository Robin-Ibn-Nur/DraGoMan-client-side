...
const ErrorPage = () => {
    return (
        ...
        >
            ...
            <div className="w-full lg:w-1/2" >
                <h1 className="py-4 text-3xl lg:text-4xl font-extrabold text-gray-50">Looks like you've found the doorway to the great nothing</h1>
                ...
                <p className="py-2 text-base text-white-800">Sorry about that! Please visit our hompage to get where you need to go.</p> <br />
